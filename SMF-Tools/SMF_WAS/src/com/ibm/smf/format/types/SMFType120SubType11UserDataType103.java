...
/**
 * The SMF 120 Subtype 11 User Data tag type 103 (z/OS Connect API provider)
 * 
 * The data for the 103 User Data section looks like this     
 * 
 *  DCL 1 zConnectUserData103,
 ...
 *        3 trackingToken    64 bytes  BINARY - z/OS Connect generated tracking token
 */
public class SMFType120SubType11UserDataType103 extends UserDataSection {
     ...
     */
    public SMFType120SubType11UserDataType103(UserDataSection uds) throws UnsupportedVersionException, UnsupportedEncodingException{
        super(uds);
