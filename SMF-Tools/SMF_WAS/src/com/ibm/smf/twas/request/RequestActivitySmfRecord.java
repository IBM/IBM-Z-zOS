...
public class RequestActivitySmfRecord extends WASSmfRecord {
   ...
   */
  public RequestActivitySmfRecord(SmfRecord aSmfRecord)
  throws UnsupportedVersionException, UnsupportedEncodingException, SkipFilteredRecord {
    ...
    s = System.getProperty("com.ibm.ws390.smf.smf1209.matchCluster");
    if ((s!=null)&&(!s.equalsIgnoreCase(m_platformNeutralSection.m_clusterShortName))) {
    	throw new SkipFilteredRecord();
    }
    ...
    {    
     ...
     s = System.getProperty("com.ibm.ws390.smf.smf1209.RespRatioMin");
     if (s!=null){
     	...
     	if (m_zosRequestInfoSection.m_EnclaveDeleteRespTimeRatio<=respRatioMin.intValue()) {
     		throw new SkipFilteredRecord();
     	}
     }    
